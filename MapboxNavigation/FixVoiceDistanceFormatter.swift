...
struct RoundingTable {
    struct Threshold {
        ...
        func localizedDistanceString(for distance: CLLocationDistance, using formatter: FixVoiceDistanceFormatter) -> String {
            switch unit {
            case .mile:
...
@objc(MBFixVoiceDistanceFormatter)
public class FixVoiceDistanceFormatter: LengthFormatter {
    ...
    /**
     Intializes a new `FixVoiceDistanceFormatter`.
